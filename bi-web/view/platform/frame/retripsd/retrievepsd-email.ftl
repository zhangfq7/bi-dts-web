		...
		<div class="row">
				<div class="listMsg">
					<ul class="list-unstyled">
						<li>
							<label><@spring.message code="retripsd.label.secondStep.oneTipMsg"/></label>
						</li>   
						<li> 
							<label class="col-xs-4 "><@spring.message code="retripsd.label.secondStep.twoTipMsg"/></label>
							<label id="email">${Session["email"]}</label>
						</li>
						<li>
							<label class="col-xs-4 "><@spring.message code="retripsd.label.validateCode"/></label>
							<input type="text" placeholder=<@spring.message code='retripsd.label.fourNumber'/> class="validate-number form-control " id="msg">
						...
						<li id="tip" style="display:none">
							<small class="text-muted check-code-tip col-xs-offset-4" ><@spring.message code="retripsd.label.secondStep.threeTipMsg"/></small>
						</li>
						<li>
							<input type="text" placeholder=<@spring.message code='retripsd.label.code'/> class="code-number form-control col-xs-offset-4 col-xs-3" id="code">
						...
						<li>
						  <div class="col-xs-offset-4 ">
					        <a class="btn btn-sm btn-info btn-next col-sm-offset-"><@spring.message code="retripsd.label.nextStep"/></a>
				          </div>
						</li>
					</ul>
				</div>
...
_require(
{
	paths : {
		...
		'retripsd/forgetpsd/emailValidate':'${resPath}/resources/platform/frame/retripsd/js/retrievepsd-email'
	}
},
'retripsd/forgetpsd/emailValidate'
);
</script>
