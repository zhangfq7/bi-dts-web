...
<link rel="stylesheet" href="${resPath}/resources/platform/resmanage/data/css/data-table-import-dacp.css${css_version}" />
	...
	<div class="table-info" id="tableInfo">
		<ul id="tableForm" class="table-info-pane validationEngineContainer">
			<li class="form-group form-group-sm">
				...
				<div class="input-class divDispaly">
					<#if dataId != "" || interfaceTag == true>
						<input class="form-control" type="text" id="dataTable" disabled/>
					<#else>
						<select class="form-control chosen-select" data-placeholder="请选择数据库表" id="dataTable">
						</select>
					</#if>
				</div>
				<div class="label-class divDispaly">
			...
			<li class="form-group form-group-sm">
				...
				<div class="input-class divDispaly">
					<#if interfaceTag == true>
						<select class="form-control chosen-select" data-placeholder="<@spring.message code="data.import.selectSplitType"/>" id="splitType">
					<#else>
						<select class="form-control chosen-select" data-placeholder="<@spring.message code="data.import.selectSplitType"/>" id="splitType" disabled>
					</#if>
...
{
	paths : {
		'platform/resmanage/data/data-table-import-dacp':'${resPath}/resources/platform/resmanage/data/js/data-table-import-dacp',
		'proviceOrCitySelect':'${resPath}/resources/platform/resmanage/data/js/data-select-proviceOrCity'
	}
},
'platform/resmanage/data/data-table-import-dacp',function(){}
);
</script>
