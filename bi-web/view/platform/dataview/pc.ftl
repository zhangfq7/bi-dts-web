...
<html>
	...
	<body class="invisible dataview">
			...
			<div id="layout_body_content_panel">
				...
				<div id="centerPanel">
					...
					<div id="tableChartPanel">
                        ...
                        <#--分享和评论放在这里-->
                        <div id="public_panel" class="public_panel invisible">
                            <div class="layout_title_panel full oper_bar" style="padding-left:22px">
                                <div style="position: absolute;">
                                    <span>评论和分享</span>
                                </div>
                                <div id="toggle_publicpanel" class="close_publicpanel">
                                    <div class="fa fa-caret-up cursor-pointer optIcon"></div>
                                </div>
                            </div>
                            <div class="public_container">
                                <div id="shareAndDownload"></div>
                                <iframe src="" frameborder="0" id="commentIframe"></iframe>
                            </div>
                        </div>
					</div>
				</div>
		...
		var reportUrl = this.location.href;
			require(['view/main2'], function(main) {
				main.init();
			});
		</script>
	</body>
