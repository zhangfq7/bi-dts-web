...
(function($) {
	...
	$.fn.zclip = function(params) {
		if (typeof params == "object" && !params.length) {
			var settings = $.extend({
				path : webpath+'/resources/platform/dataview/js/jquery/zclip/ZeroClipboard.swf',
				copy : null,
				beforeCopy : null,
				afterCopy : null,
				clickAfter : true,
...
var ZeroClipboard = {
	...
	moviePath : webpath+'/resources/platform/dataview/js/jquery/zclip/ZeroClipboard.swf',
	// URL to movie
	nextId : 1,
	// ID of next movie
	$ : function(thingy) {
...
ZeroClipboard.Client.prototype = {
	...
	glue : function(elem, appendElem, stylesToAdd) {
		...
		this.div.className = "zclip copy-url" ;
