(function () {
    ...
    UM.registerWidget('formula', {
        ...
        initContent: function (_editor, $widget) {
            ...
            var me = this;
            var formula = me.sourceData.formula;
            var lang = _editor.getLang('formula')["static"];
            var formulaUrl = UMEDITOR_CONFIG.UMEDITOR_HOME_URL + 'dialogs/formula/';
            var options = $.extend({}, lang, { 'formula_url': formulaUrl });
            var root = me.root();
