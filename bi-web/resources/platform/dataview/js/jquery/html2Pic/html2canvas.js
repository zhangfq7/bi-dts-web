...
function StackingContext(hasOwnStacking, opacity, element, parent) {
    ...
    this.contexts = [];
    this.children = []; 
    this.opacity = (this.parent ? (this.parent.stack?this.parent.stack.opacity:1) : 1) * opacity;
}
...
;function SVGNodeContainer (_node, _native) {
    this["src"] = _node;
    this["image"] = null;
    var self = this;
    ...
    this.promise = _native ? new Promise(function(resolve, reject) {
        ...
        self.image.onload = resolve;
        self.image.onerror = reject;
        self.image.src = "data:image/svg+xml," + (new XMLSerializer()).serializeToString(_node);
        if (self.image.complete === true) {
            resolve(self.image);
        }
    }) : this.hasFabric().then(function() {
        return new Promise(function(resolve) {
            html2canvas.fabric.parseSVGDocument(_node, self.createCanvas.call(self, resolve));
        });
    });
}
